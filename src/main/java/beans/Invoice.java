...
public class Invoice extends CsvBeans {
    ...
    public Invoice(String id, String status, String user_id, String reservation_id, String penalty_ids, String total_penalties, String redeemed_dollar_amount, String base_amount, String subtotal, String created_on) {
    	this.id = id;
    	this.status = status;
