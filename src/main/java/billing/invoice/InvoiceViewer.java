...
import billing.payment.method.BankTransfer;
import billing.payment.method.CreditCard;
import billing.payment.method.PayNow;
...
public class InvoiceViewer {
	...
	public static void showInvoice(Invoice invoice) {
		try {
			...
			Reservation reservation = reservationManager.getReservationById(Integer.parseInt(invoice.getReservationId())); //reservationRetriever.retrieveById(invoice.getReservationId());
