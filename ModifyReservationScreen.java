...
public class ModifyReservationScreen extends BasicWindow {
    public ModifyReservationScreen(ReservationManager manager, User currentUser) {
        ...
        panel.addComponent(new Label("New Start (yyyy-MM-dd HH:mm):"));
        TextBox startField = new TextBox();
        panel.addComponent(startField);

        panel.addComponent(new Label("New End (yyyy-MM-dd HH:mm):"));
        ...
        Button saveButton = new Button("Save Changes", () -> {
            try {
                ...
                LocalDateTime newStart = LocalDateTime.parse(startField.getText().trim(), Reservation.DATETIME_FORMAT);
                LocalDateTime newEnd = LocalDateTime.parse(endField.getText().trim(), Reservation.DATETIME_FORMAT);
